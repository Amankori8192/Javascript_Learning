...
// console.log(Array.from({name: "hitesh"}))       // return a empty array / from the object if you are try to making an array. so, you have to tell them you are trying to making an array from the keys of object or value. 
